...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "ADN Ninja Warrior — My Ninja Path" },
      { name: "description", content: "Gamified attendance tracker for ADN Ninja Warrior obstacle course gym." },
      { name: "theme-color", content: "#121212" },
      { property: "og:title", content: "ADN Ninja Warrior" },
      { property: "og:description", content: "Track your ninja progress, unlock obstacles, earn pins." },
